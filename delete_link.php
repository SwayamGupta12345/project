...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['confirm_delete']) && isset($_POST['sem']) && isset($_POST['id'])) {
    ...
    if ($stmt->execute()) {
        $success = true;
        $message = "The subject has been successfully deleted from semester $sem.";
    } else {
...
<head>
    ...
    <link rel="stylesheet" href="delete_link.css">
...
<div class="container">
    ...
    <?php else: ?>
        ...
        <form method="POST">
            ...
            <input type="submit" name="confirm_delete" value="Delete Selected Subject data" class="btn" onclick="return confirm('Are you sure you want to delete this subject?');">
        </form>
